...
public class GuestEventId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if(!(o instanceof GuestEventId)) return false;//Проверява инстанцията дали е от точно тоци тип
        GuestEventId that = (GuestEventId) o;//Каства
        return that.eventId.equals(this.eventId) && that.guestId.equals(this.guestId);// Проверява даи стойностите са еднакви
    }
